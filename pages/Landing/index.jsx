        ...
        <div className="landing-hero">
          <div className="landing-hero-text">
            ...
            <p className="landing-hero-body">
              با ایران‌سند، اسناد خود را به صورت برخط ایجاد، ویرایش و مدیریت
          ...
          <div className="landing-join-body">
            ...
            <div className="landing-join-body-content">
              ...
              <p className="landing-join-body-content-text">
                ...
                در ایجاد، ویرایش و مدیریت اسناد به صورت آنلاین آغاز به فعالیت
                کرده است! با قابلیت‌های پیشرفته‌ای مانند ویرایش همزمان،
                ذخیره‌سازی ابری، پشتیبانی از فرمت‌های مختلف و ابزارهای هوشمند
                نوشتاری، ایران‌سند تجربه‌ای سریع، امن و کاربرپسند را در اختیار
                شما قرار می‌دهد. ایران سند مناسب تولید و اشتراک گذاری اسناد برای
                انواع کارهای شخصی، تحصیلی، شغلی و حرفه ای است. ایران‌سند همراه
                همیشگی شما در دنیای دیجیتال است!
              </p>
              <button
