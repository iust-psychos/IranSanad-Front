            ...
            <div className={styles.InformationContainer}>
              ...
              >
                ...
                <div className={styles.sliderBtns}>
                  <CircleIcon onClick={handleFirst} fontSize="small" sx={{
                      color:"#B2B2B2"
                    }}/>
                  <CircleIcon onClick={handleSecond} fontSize="small" sx={{
                      color:"#B2B2B2"
                    }}/>
                  <CircleIcon onClick={handleThird} fontSize="small" sx={{
                      color:"#FFFFFF"
                    }}/>
                  <CircleIcon onClick={handleFourth} fontSize="small" sx={{
                      color:"#B2B2B2"
                    }}/>
                </div>
